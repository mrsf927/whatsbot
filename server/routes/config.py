...
def register_routes(app, deps):
    ...
    async def get_config():
        return _ok({
            ...
            "human_transfer_notify_enabled": settings.get("human_transfer_notify_enabled", False),
            "human_transfer_notify_target": settings.get("human_transfer_notify_target", ""),
            "human_transfer_notify_message": settings.get("human_transfer_notify_message", ""),
